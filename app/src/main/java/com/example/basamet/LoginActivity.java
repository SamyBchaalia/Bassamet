                ...
                passwordResetDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
                        ...
                        fAuth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            {
                                Toast.makeText(LoginActivity.this,"Reset Link Send To Your E-mail",Toast.LENGTH_LONG).show();
                                progressBar.setVisibility(View.INVISIBLE);
                            }
                            ...
                            {
                                Toast.makeText(LoginActivity.this,"Error ! Reset Link is Not Send " +e.getMessage(),Toast.LENGTH_LONG).show();
                                progressBar.setVisibility(View.INVISIBLE);
                            }
                        });
                    }
        ...
        mFirebaseAuth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                else
                {
                    ...
                    Toast.makeText(LoginActivity.this,"Authenfication Failed" , Toast.LENGTH_SHORT).show();
                    //updateUI(null);
                }
            }
        });
